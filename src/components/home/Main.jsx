  ...
  return (
    <div className='flex flex-col'>
      ...
      <section className='flex flex-col'>
        ...
        <div className='top flex flex-col justify-center items-center py-6' style={{backgroundColor: '#D4F4E2'}}>
          <h1 className='font-bold text-2xl'>How It Works</h1>
          <p className='text-xl'>Learn how Immunicare works so as to maximize it’s benefits</p>
        </div>
      ...
      <section className='flex flex-col' style={{backgroundColor: 'hsla(0, 0%, 100%, 1)'}}>
        ...
        <div className='top flex flex-col justify-center items-center py-6' style={{backgroundColor: '#D4F4E2'}}>
          ...
          <p className='text-xl'>Why Choose Our Platform?</p>
        </div>
      ...
      <section className='flex flex-col mt-8' style={{backgroundColor: 'hsla(0, 0%, 98%, 1)'}}>
        ...
        <div className='top flex flex-col justify-center items-center py-6' style={{backgroundColor: '#D4F4E2'}}>
          ...
          <p className='text-xl'>What People say about us</p>
        </div>
      ...
      <section className='flex flex-col justify-center items-center text-center py-8 text-white' style={{backgroundColor: '#3632ff'}}>

        <h1 className='font-medium text-2xl'>Ready to Get Started?</h1>

        <p className='text-xl font-light'>Join us in protecting children’s health</p>

        <button className='mt-8 bg-white text-blue-800 font-medium text-sm rounded-md px-10 py-4'>Sign Up Now!</button>
